...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> 03457557023")
...
▒█░▒█ ▒█░▒█ ▒█░░▀█ ▒█▄▄█ ▒█░▒█ ▒█░▒█
    ...
    └───────────────────────────────────────┘  """)
		...
		print("\033[97;1m   ───────────────────────────────────────")
		print("\033[92;1m         Ranjha Yasir YT    x   Pro Pronoy      ")
		print("\033[97;1m   ───────────────────────────────────────")
		print("\n%s [%s1%s]%s CRACK RANDOM FB ID 2008-11 %s(FREE)"%(G,R,G,Y,W))
		print("%s [%s2%s]%s CRACK FB ID 2015-22 %s(PRO-SPY) V1"%(G,R,G,Y,G))
		print("%s [%s3%s]%s CRACK FROM NUMBER  %s(SPY) VIP"%(G,R,G,Y,G))
		print("%s [%s4%s]%s CRACK FB ID 2004-5%s(PRO-SPY) VIP-1"%(G,R,G,Y,G))
